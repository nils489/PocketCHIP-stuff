...
#define WATCH {.v = (char *[]){ "/bin/sh", "-c", \
	    "st -e \
	    /home/chip/scripts/ytvid.sh $(xprop -id $0 _SURF_URI | cut -d \\\" -f 2)", \
	    winid, NULL } }

#define VDOWN {.v = (char *[]){ "/bin/sh", "-c", \
	    "st -e \
	    /home/chip/scripts/vdown.sh $(xprop -id $0 _SURF_URI | cut -d \\\" -f 2)", \
	    winid, NULL } }
...
static Key keys[] = {
	...
	{ MODKEY,               XK_KP_Down,      scroll_v,   { .i = +1 } },
	{ MODKEY,               XK_KP_Up,      scroll_v,   { .i = -1 } },
	{ MODKEY,               XK_KP_Left,      scroll_h,   { .i = -1 } },
	{ MODKEY,               XK_KP_Right,      scroll_v,   { .i = +1 } },
	{ MODKEY,               GDK_b,      scroll_v,   { .i = -10000 } },
	{ MODKEY,               GDK_space,  scroll_v,   { .i = +10000 } },
	{ MODKEY,               XK_KP_Right,      scroll_h,   { .i = +1 } },
	{ MODKEY,               XK_KP_Left,      scroll_h,   { .i = -1 } },
